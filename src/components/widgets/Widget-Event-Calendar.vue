	...
	<div class="widget__content card__content">
		...
		<div class="alc-event-calendar">
			<table class="table table-bordered">
				...
				<thead>
					<tr>
						<th data-weekday-abbr="Mon"><span class="weekday">Monday</span></th>
						<th data-weekday-abbr="Tue"><span class="weekday">Tuesday</span></th>
						<th data-weekday-abbr="Wed"><span class="weekday">Wednesday</span></th>
						<th data-weekday-abbr="Thu"><span class="weekday">Thursday</span></th>
						<th data-weekday-abbr="Fri"><span class="weekday">Friday</span></th>
						<th data-weekday-abbr="Sat"><span class="weekday">Saturday</span></th>
						<th data-weekday-abbr="Sun"><span class="weekday">Sunday</span></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<h6 class="alc-event-calendar__event alc-event-calendar__event--type-1">
								<a href="_esports_event-overview-1a.html">Game Huntress "Inktoon 2" Stream</a>
							</h6>
						</td>
					...
					<tr>
						...
						<td>
							...
							<h6 class="alc-event-calendar__event alc-event-calendar__event--type-4">
								<a href="_esports_event-overview-1b.html">Xenowatch Patch 5.6 Update Release</a>
							</h6>
						</td>
		...
		<ul class="alc-event-list list-unstyled">
			<li class="alc-event-list__item alc-event-list-item alc-event-list-item--type-1">
				...
				<div class="alc-event-list-item__body">
					...
					<div class="alc-event-list-item__cta">
						<a href="#" class="btn btn-default-alt btn-xs">Check More Details</a>
					</div>
				</div>
			</li>
